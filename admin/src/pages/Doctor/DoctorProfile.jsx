        ...
        <div >
            <div className='flex flex-col gap-4 m-5'>
                ...
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                    ...
                    <div>
                        <p className='flex items-center gap-1 text-m font-medium text-neutral-900 mt-3'>About : </p>
                        <p className='text-sm text-gray-600 max-w-[700px] mt-1'>{profileData.about}</p>
                    </div>
                    <p  className='mt-3 text-m text-gray-600'>
                        Appointment Fees : <span className='text-gray-850'>{currency} { isEdit ? <input type="number" onChange={(e)=>setProfileData(prev=>({...prev,fees:e.target.value}))} value ={profileData.fee}/> :profileData.fees}</span>
                    </p>
